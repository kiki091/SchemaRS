                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-tablet-landscape-md-8">
                                ...
                                <div id="error-banner-text-content">
                                    <h1 class="large-version">503 We're sorry</h1>
                                    <p>Our servers are over capacity and certain pages may be temporarily unavailable. We're working quickly to resolve the issue</p>
                                </div>
